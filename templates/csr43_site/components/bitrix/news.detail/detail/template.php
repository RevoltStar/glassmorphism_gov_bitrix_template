...
<div class="news-detail news-detail__container">
    <div class="csr43-glass-card csr43-glass-card--interactive news-detail__card p-4 p-lg-5 mb-4">
		 <!-- Заголовок новости -->
        ...
        <div class="row g-4">
            ...
            <aside class="col-lg-4 order-1 order-lg-2">
                ...
                <?php if (!empty($galleryFiles)): ?>
                    ...
                    <section class="csr43-glass-card csr43-glass-card--interactive news-detail__card p-4 mb-4">
                ...
                <section class="csr43-glass-card csr43-glass-card--interactive news-detail__card p-4">
                    <h5 class="news-detail__section-title mb-3">
