<?php
$MESS['CSR43_LIGHT_FILES_UPDATED'] = 'Обновлено:';
$MESS['CSR43_LIGHT_FILES_TOGGLE'] = 'Показать или скрыть материалы';
...
$MESS['CSR43_LIGHT_FILES_EMPTY_TEXT'] = 'Файлы временно недоступны, находятся на обновлении или будут добавлены позже.';
